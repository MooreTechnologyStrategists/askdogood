...
const AffiliateLink: React.FC<AffiliateLinkProps> = ({
  ...
  if (variant === 'card') {
    return (
      <div className={`border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow ${className}`}>
        {imageUrl && (
        ...
        <div className="p-4">
          ...
          <a
            ...
            rel="noopener noreferrer nofollow sponsored"
            onClick={handleClick}
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF9900] hover:bg-[#FF9900]/90 text-white font-semibold rounded transition-colors w-full justify-center"
          >
