...
const foodImages = [
  ...
  },
  {
    ...
    caption: 'Black Bean Burgers'
  },
  {
    src: '/images/personal/food/vegetables-roasted.jpg',
    alt: 'Roasted vegetables with anti-inflammatory spices',
    caption: 'Roasted Veggies'
  },
  {
    src: '/images/personal/food/cookies-healthy.jpg',
    alt: 'Healthy thyroid-friendly cookies',
    caption: 'Healthy Treats'
  },
  {
    src: '/images/personal/food/smoothie-purple.jpg',
    alt: 'Purple antioxidant smoothie',
    caption: 'Berry Smoothie'
  },
  {
    src: '/images/personal/food/vegetables-fresh.jpg',
    alt: 'Fresh organic vegetables',
    caption: 'Fresh Veggies'
  }
];
