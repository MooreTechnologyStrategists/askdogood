      ...
      <div className="container max-w-4xl py-12 relative z-10">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-8">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-4 font-serif text-primary">Nutrition Facts (Per Burger)</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-3 bg-primary/5 border border-primary/20 rounded">
                  <p className="text-sm text-primary">Calories</p>
                  <p className="text-2xl font-bold text-foreground">220</p>
                </div>
                <div className="p-3 bg-primary/5 border border-primary/20 rounded">
                  <p className="text-sm text-primary">Protein</p>
                  <p className="text-2xl font-bold text-foreground">12g</p>
                </div>
                <div className="p-3 bg-primary/5 border border-primary/20 rounded">
                  <p className="text-sm text-primary">Carbs</p>
                  <p className="text-2xl font-bold text-foreground">18g</p>
                </div>
                <div className="p-3 bg-primary/5 border border-primary/20 rounded">
                  <p className="text-sm text-primary">Fat</p>
                  <p className="text-2xl font-bold text-foreground">10g</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-3xl font-bold mb-4 font-serif text-primary">Health Benefits</h2>
          ...
          <aside className="md:col-span-1">
            <div className="sticky top-4 bg-card border border-primary/20 backdrop-blur rounded-xl p-6 shadow-lg">
              <img 
                ...
                className="w-full rounded-lg mb-4 object-cover h-48 border border-primary/20"
              />
