...
export const flagshipDigitalProducts: CatalogItem[] = [
  ...
  },
  {
    ...
    status: "Needs live checkout and cover image",
    shortSummary:
...
export const serviceCatalog: CatalogItem[] = [
  {
    ...
    priceLabel: "$297",
    slug: "discovery-call",
    status: "Stripe or invoice",
    shortSummary: "60-minute strategy call with personalized next steps.",
    description: "A one-on-one video call with lab review, personalized action planning, and practical follow-up guidance.",
    cta: "Book your one-on-one reset call.",
    image: "/images/branding/askdogood-logo-navy.png",
    category: "Service",
  ...
  },
  {
    ...
    status: "Stripe or invoice",
    shortSummary: "Ongoing support, coaching, planning, and accountability.",
    description: "Four coaching sessions per month, custom planning, weekly check-ins, and deeper support for women who want a structured path forward.",
    cta: "Get deeper support and a structured path forward.",
    image: "/images/branding/askdogood-logo-orange.png",
  ...
  },
  {
    ...
    slug: "vip-intensive",
    status: "Stripe or invoice",
    shortSummary: "Deep-dive support with a custom plan.",
    description: "A focused premium intensive with a detailed review, custom recommendations, and a 90-day strategic roadmap.",
    cta: "Spend a focused day rebuilding your strategy.",
  ...
  },
  {
    ...
    name: "Meal Prep Workshop",
    kind: "service",
    platform: "stripe",
    priceLabel: "$75",
    slug: "meal-prep-workshop",
    status: "Needs payment link",
    shortSummary: "Practical group workshop for wellness and food prep.",
    description: "In-person or virtual support focused on building a meal prep system that is realistic, efficient, and sustainable.",
    cta: "Learn how to prep without overwhelm.",
    image: "/images/branding/askdogood-logo-navy.png",
    category: "Workshop",
  ...
  },
  {
    ...
    name: "Private Meal Prep Coaching",
    kind: "service",
    platform: "stripe",
    priceLabel: "$97",
    slug: "private-meal-prep-coaching",
    status: "Needs payment link",
    shortSummary: "Personalized food and prep support.",
    description: "A lower-ticket support offer for people who need help organizing meals, prep strategy, and practical nutrition habits.",
    cta: "Get simple, real-life meal prep help.",
    image: "/images/branding/askdogood-logo-orange.png",
    category: "Service",
    internalPath: "/meal-prep",
  },
